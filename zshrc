...
alias pmmi='perl Makefile.PL && make && sudo make install'
alias ptmmi='perl Makefile.PL && make test && sudo make install'
...
alias rert="unrt && (cd ~; sudo /opt/rt3/bin/standalone_httpd 8888)"
